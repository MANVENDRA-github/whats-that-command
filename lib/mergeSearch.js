...
//
// SEM_FLOOR is tuned for the potion (Model2Vec) static embeddings: their
// pure-noise cosine sits around ~0.40, genuine intent matches at ~0.55+.
// The smoke test printed by scripts/build-static-embeddings.mjs is the
// quickest way to re-check this distribution after dataset changes.

const FUSE_W = 0.35;
const SEM_W = 0.65;
const SEM_FLOOR = 0.48;
